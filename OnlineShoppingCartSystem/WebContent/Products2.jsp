				...
				<div class="span9">
					...
					<div class="tab-content">
						<%
							...
							ArrayList<String> sl = db.showProduct(request
									.getParameter("cat_id"));
						%>
							...
							<%
								for (int i = 0; i < sl.size(); i++) {
									...
									out.print("<div class=row><div class=span2><img height='160' width='160' src=themes/images/products/"
											...
											+ pid
											+ " name='pid'>View Details</a></form><br class=clr/></div><div class=span3 alignR><form class=form-horizontal qtyFrm action=AddtoCart><h3>&nbsp;&nbsp;&nbsp;Rs."
											+ r
								...
								<%
									for (int i = 0; i < sl.size(); i++) {
										...
										out.print("<li class=span3><div class=thumbnail><img height='160' width='160' src=themes/images/products/"
												...
												+ pid
												+ " name='pid'><i class=icon-zoom-in></i></button></form><form action=AddtoCart method=get><button type=submit name='pid' value="
												+ pid

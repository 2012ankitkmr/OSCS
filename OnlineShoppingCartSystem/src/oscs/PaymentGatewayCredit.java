 ...
 */
@WebServlet("/PaymentGatewayCredit")
public class PaymentGatewayCredit extends HttpServlet {
	...
	System.out.println(card_number.substring(0,2) +","+!card_number.substring(0,2).equals("51")+","+!card_number.substring(0,2).equals("55"));
